...
export const profileDataStructure = {
  personal_info: { username: "", fullname: "", profile_img: "", bio: "" },
  ...
  return (
    <AnimationWrapper>
      {loading ? (
        ...
        <section className="h-cover md:flex flex-row-reverse items-start gap-5 min-w-[1100px]:gap-12 md:w-[50%] md:pl-8 md:border-1 border-grey ">
